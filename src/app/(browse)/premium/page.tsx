        ...
        >
            <div className="max-w-6xl mx-auto px-4 pt-10 pb-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                    ...
                    {/* Plan mensual — div exterior: solo animación */}
                    <div className="animate-fade-up" style={{ animationDelay: '80ms' }}>
                        {/* div interior: hover + contenido */}
                        <div
                            className="relative h-full bg-white rounded-3xl shadow-lg flex flex-col items-center text-center px-12 py-8
                            cursor-pointer transition-all duration-300 ease-out hover:scale-105 hover:shadow-xl"
                        ...
                        >
                            ...
                            <ul className="space-y-2 mt-3 mb-6 font-medium text-stone-500">
                                ...
                                <li className="flex items-center gap-2">
                                    <GrFormCheckmark className="w-6 h-6 text-lime-500" />
                                    Selección de ruta por intención
                                </li>
                                <li className="flex items-center gap-2">
                                    <GrFormCheckmark className="w-6 h-6 text-lime-500" />
                                    Seguimiento post-ruta
                                </li>
                                <li className="flex items-center gap-2">
                                    <GrFormCheckmark className="w-6 h-6 text-lime-500" />
                                    Comunidad no competitiva
                                </li>
                            </ul>
                    ...
                    {/* Plan anual — div exterior: solo animación */}
